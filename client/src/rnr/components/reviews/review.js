  ...
  return (
    <div className="review">
      ...
      <div className="review-user-header">
        Verified, {reviewData.reviewData.reviewer_name}, {reviewMonth}{" "}
        {reviewDay}, {reviewYear}
      </div>
      <div className="review-summary">{reviewData.reviewData.summary}</div>
      <div className="review-body">{reviewData.reviewData.body}</div>
      <div className="review-recommend">
        {reviewData.reviewData.recommend === true
          ? "I recommend this product"
          : ""}
      </div>
      <div className="review-response">
        {reviewData.reviewData.response === null
          ? ""
          : reviewData.reviewData.response}
      </div>
      <div className="review-footer">
        <div className="review-helpful">Helfpul?</div>
        <div className="review-yes">Yes</div>
