...
function Rating({ starData }) {
  ...
  return (
    <div className={containerClassName}>
      <span className={textClassName}>{starData.stars} stars</span>
      <span
        className={greenBarClassName}
        style={{
          display: "inline-block",
          marginLeft: "15px",
          backgroundColor: "green",
          height: "10px",
          width: greenBarPercentage,
        }}
      ></span>
      <span
        className={grayBarClassName}
        style={{
          display: "inline-block",
          marginLeft: "0px",
          backgroundColor: "#a5acb8",
          height: "10px",
          width: grayBarPercentage,
        }}
      ></span>
    </div>
  );
